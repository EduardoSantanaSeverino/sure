class UI::AccountPage < ApplicationComponent
  ...
  renders_one :activity_feed, ->(feed_data:, pagy:, search:, compact: false, group_by_date: true, running_balances: {}) { UI::Account::ActivityFeed.new(feed_data: feed_data, pagy: pagy, search: search, compact: compact, group_by_date: group_by_date, running_balances: running_balances) }
