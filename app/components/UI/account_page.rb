class UI::AccountPage < ApplicationComponent
  ...
  renders_one :activity_feed, ->(feed_data:, pagy:, search:, compact: false, group_by_date: true) { UI::Account::ActivityFeed.new(feed_data: feed_data, pagy: pagy, search: search, compact: compact, group_by_date: group_by_date) }
